 ...
 */
class Tidakbernpwp extends CI_Controller {
	/**
	 * Constructor
	 */
	function Tidakbernpwp()
	{
		parent::__Construct();
		$this->load->model('Surat_model', '', TRUE);
		$this->load->model('NPWP_model', '', TRUE);
		$this->load->library('session');
        $this->load->library('cfpdf');
		$this->load->model('Info_model', '', TRUE);
	}
	
	var $title = 'Tidak Ber-NPWP';
	...
	function main()
	{
		...
		$data['h2_title'] = 'Tidak Ber-NPWP';
		$data['main_view'] = 'surat/tidakbernpwp_view';
		$data['left_view'] = 'menusurat.php';
		$data['user'] = $this->session->userdata('username');
		$data['form_action'] = site_url('tidakbernpwp/add_bps');
	...
	//========================== Awal counter MNPWP =========================
		$countmnpwpe = $this->Surat_model->get_countermnpwp();
		$countermnpwpnya = $countmnpwpe->row();
		//echo $counterbpsnya->counterbps;
		$data['default']['mnpwpcounter']=$countermnpwpnya->contermnpwp;
	...
	{
		$data['title'] = $this->title;
		$data['h2_title'] = 'Surat Tidak Ber-NPWP';
		$data['main_view'] = 'surat/tidakbernpwp_print';
		$data['left_view'] = 'menusurat.php';
		$data['user'] = $this->session->userdata('username');			
		...
		// ====================== Set validation rules ======================
			$this->form_validation->set_rules('namawp', 'Nama Wajib Pajak', 'required');
			$this->form_validation->set_rules('alamatwp', 'Alamat Wajib Pajak', 'required');
...
//			redirect('tidakbernpwp/add_bps');
		...
		$data['default']['nama'] = $NAMA;
		$data['default']['alamat'] = $ALAMAT;
