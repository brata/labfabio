...
class Masa extends CI_Controller {
	...
	function main()
	{
		...
		$data['h2_title'] = 'SPT Masa';
		$data['main_view'] = 'spt/masa_view';
		$data['left_view'] = 'menuspt.php';
		$data['user'] = $this->session->userdata('username');
		$data['form_action'] = site_url('masa/add_masa');
		...
		$data['option_jenisspt'] = $this->SPT_model->getJenisSPT('2');
	...
	function add_masa()
	{
		$data['title'] = $this->title;
		$data['h2_title'] = 'SPT Masa';
		$data['main_view'] = 'spt/masa_print';
		$data['left_view'] = 'menuspt.php';
		$data['user'] = $this->session->userdata('username');		
		$data['form_action'] = site_url('masa/cetak_dokumen');
		...
		//	$this->form_validation->set_rules('nominalkodenkl', 'Nominal N|K|L', 'required');
