...
<form name="carispt_form" method="post" action="<?php echo $form_action; ?>">
	...
	<p>
	  <label for="tglterima"><?php echo form_checkbox('tglterima_check', '17', FALSE);?>Tanggal Terima :</label>
    	<?php
	...
	<p>
	  <label for="bulanterima"><?php echo form_checkbox('bulanterima_check', '35', FALSE);?>Bulan Terima :</label>
    	<?php
	...
	<p>
	  <label for="tahunterima"><?php echo form_checkbox('tahunterima_check', '67', FALSE);?>Tahun Terima :</label>
    	<?php
	...
	<p>
		...
		<? echo form_checkbox('semua_check','2000');?> Semua
		<? echo form_checkbox('masa_check','135');?> Masa
		<? echo form_checkbox('tahunan_check','269');?> Tahunan
		<? echo form_checkbox('ppn_check','539');?> PPN
	</p>
