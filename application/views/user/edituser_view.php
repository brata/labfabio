...
<form name="bernpwp_form" method="post" action="<?php echo $form_action; ?>">
	<p>
		...
		<input type="text" class="form_field" name="usrnama" size="16" value="<?php echo set_value('usrnama', isset($default['usrnama']) ? $default['usrnama'] : ''); ?>" readonly="<?php echo set_value('readusrnama', isset($default['readusrnama']) ? $default['readusrnama'] : ''); ?>"/>
	</p>
