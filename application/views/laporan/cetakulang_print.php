...
<form name="bernpwp_form" method="post" action="<?php echo $form_action; ?>"  target="_blank">
	<p>
		...
		<input type="text" class="form_field" name="nobps" size="28" value="<?php echo set_value('nobps', isset($default['nobps']) ? $default['nobps'] : ''); ?>" />
	</p>	
	<p>
	...
	<p>
		...
		<input type="text" class="form_field" name="nama" size="40" value="<?php echo set_value('nama', isset($default['nama']) ? $default['nama'] : ''); ?>" />
	</p>
	<p>
		<label for="alamat">Alamat :</label>
		<input type="text" class="form_field" name="alamat" size="60" value="<?php echo set_value('alamat', isset($default['alamat']) ? $default['alamat'] : ''); ?>" />
	</p>	
	<p>
		<label for="tglterima">Tanggal Terima :</label>
		<input type="text" id="datepicker" class="form_field" name="tglterima" size="16" value="<?php echo set_value('tglterima', isset($default['tglterima']) ? $default['tglterima'] : ''); ?>" />
	</p>
	<p>
	...
	<p>
      ...
      <input type="text" class="form_field" name="jenisdokumen" size="40" value="<?php echo set_value('jenisdokumen', isset($default['jenisdokumen']) ? $default['jenisdokumen'] : ''); ?>" />
	</p>
	<p>
